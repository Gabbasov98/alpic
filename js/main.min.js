...
$(".use-item__top").click(function () {
    $(this).parents(".use-item").toggleClass("_open")
    $(this).siblings(".use-item__bottom").slideToggle()
})
...
window.addEventListener('DOMContentLoaded', () => {
    ...
    $('.js-select2').each(function (){
        $(this).select2({
            ...
            dropdownCssClass : $(this).attr('data-css-class'),
            language: {
                noResults: function(){
